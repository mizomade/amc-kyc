                  ...
                  class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" />
                    ...
                    <div>
                      <button
                        ...
                        class="mt-2 w-full py-2 px-4 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition"
                      >
                        Pick from Map
                      </button>
                    </div>
          ...
          <MapModal
            ...
            <div v-if="activeTab === 'members'">
              ...
              <div class="max-h-80 overflow-y-auto border border-gray-200 rounded-lg">
                <div class="p-4">
                  <p class="text-lg text-gray-500">Members List</p>
                </div>
                <div v-if="houseStore.members.length > 0">
                  <ul class="divide-y divide-gray-200">
                    <li v-for="member in houseStore.members" :key="member.id" class="py-2 px-4 flex items-center cursor-pointer hover:bg-gray-100" @click="goToPerson(member.id)">
