<template>
    <div
      :class="[
        'relative flex flex-col h-screen bg-white p-4 text-gray-700 shadow-xl transition-all duration-300',
    ...
    >
      ...
      <nav class="flex flex-col gap-1 p-2 text-base font-normal text-blue-gray-700">
        <button
          ...
          class="flex items-center w-full p-3 rounded-lg text-start outline-none hover:bg-blue-50 hover:text-blue-900 transition"
        >
